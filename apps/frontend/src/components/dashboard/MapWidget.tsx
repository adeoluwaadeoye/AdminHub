        ...
        <div className="mt-4 space-y-2">
          {regions.map((r) => (
            <div
              ...
              className={`flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors ${active?.id === r.id
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <Badge className={`text-[10px] px-2 py-0 ${r.positive
                    ? "bg-green-100 text-green-700"
                    : "bg-red-100 text-red-600"
                  }`}>
                  {r.growth}

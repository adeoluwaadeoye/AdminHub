    ...
    <section className="relative bg-background py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 md:px-6">
        ...
        {/*
          ...
          tablet:  single column stacked (app card below text)
        ...
        */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-start">
            <Badge className="mb-5 px-3 py-1.5 bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 text-sm">
              Get Started Today
            </Badge>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {user ? (
                <Link href="/dashboard">
                  <Button
                    size="lg"
                    className="gap-2 bg-indigo-600 hover:bg-indigo-700 text-white cursor-pointer text-base"
                  >
                    Open Dashboard
          ...
          */}
          <div className="flex justify-center lg:justify-end w-full">
            <div className="w-full max-w-sm rounded-2xl border bg-card shadow-xl p-5 md:p-6 space-y-5">

              {/* APP HEADER */}
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 md:h-14 md:w-14 rounded-2xl bg-indigo-600 flex items-center justify-center shrink-0">
                  <HiOutlineBolt className="h-6 w-6 md:h-7 md:w-7 text-white" />
                </div>
                <div className="min-w-0">
                  <p className="font-semibold text-base truncate">AdminHub</p>
              ...
              <div className="space-y-2.5">
                <Link href="#">
                  <div className="flex items-center gap-3 rounded-xl border bg-background px-4 py-3 hover:bg-muted transition-colors cursor-pointer">
                    <FaApple className="h-6 w-6 md:h-7 md:w-7 shrink-0" />
                    <div className="min-w-0">
                      <p className="text-xs text-muted-foreground leading-none">
                        Download on the
                      </p>
                      <p className="text-sm md:text-base font-semibold leading-tight mt-0.5">
                        App Store
                      </p>
                    </div>
                    <Badge className="ml-auto text-xs bg-indigo-100 text-indigo-700 shrink-0">
                      Soon
                    </Badge>
                  </div>
                </Link>
                ...
                <Link href="#">
                  <div className="flex items-center gap-3 rounded-xl border bg-background px-4 py-3 hover:bg-muted transition-colors cursor-pointer">
                    <FaGooglePlay className="h-5 w-5 md:h-6 md:w-6 text-green-500 shrink-0" />
                    <div className="min-w-0">
                      <p className="text-xs text-muted-foreground leading-none">
                        Get it on
                      </p>
              ...
              <div className="flex items-center gap-4 pt-2 border-t">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground mt-1 leading-relaxed">
                    Point your camera at the QR code to open AdminHub on
